...
for %%F in (%*) do (
    if exist "%%F" (
        if exist "%%F\*" (
            ...
            .\repak.exe --aes-key 0C263D8C22DCB085894899C3A3796383E9BF9DE0CBFB08C9BF2DEF2E84F29D74 pack %%F --version V11 --compression Oodle
            ...
            if /i "!fileExt!"==".pak" (
                ...
                @pushd %%~dpF
                :: Unpack the .pak file
                .\repak.exe --aes-key 0C263D8C22DCB085894899C3A3796383E9BF9DE0CBFB08C9BF2DEF2E84F29D74 unpack %%F
                @del %%F

                :: Pack the folder back with the new name
                .\repak.exe --aes-key 0C263D8C22DCB085894899C3A3796383E9BF9DE0CBFB08C9BF2DEF2E84F29D74 pack "%%~dpnF" --version V11 --compression Oodle
                :: Get folder name
                set "folderName=%%~nF"
                set "has9999999=0"
                set "hasP=0"
